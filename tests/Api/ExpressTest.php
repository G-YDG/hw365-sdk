 ...
 * @coversNothing
 */
class ExpressTest extends AbstractTest
{
    public function testEntrance()
    {
        ...
        $url = $app->express->entrance([
            'timestamp' => 1690363148506,
            'user_id' => 1,
            'extra' => 't_1',
        ]);
        $cUrl = 'https://ot.jfshou.cn/privilege-api/express/delivery/auth/index?timestamp=1690363148506&user_id=1&extra=t_1&share_code=123456&sign=101381E240CD6778DD7328A6EDBAFA0E';
    ...
    public function testQueryOrder()
    {
        ...
        $response = $app->express->queryOrder([
