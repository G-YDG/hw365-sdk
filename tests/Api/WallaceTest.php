 ...
 * @coversNothing
 */
class WallaceTest extends AbstractTest
{
    public function testEntrance()
    {
        ...
        $url = $app->wallace->entrance([
            'timestamp' => 1690363148506,
            'user_id' => 1,
            'extra' => 't_1',
        ]);
        $cUrl = 'https://ot.jfshou.cn/privilege-api/wallace/auth/index?timestamp=1690363148506&user_id=1&extra=t_1&share_code=123456&sign=101381E240CD6778DD7328A6EDBAFA0E';
    ...
    public function testQueryOrder()
    {
        ...
        $response = $app->wallace->queryOrder([
